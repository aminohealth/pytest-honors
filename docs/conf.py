# -*- coding: utf-8 -*-
#
# pytest-honors documentation build configuration file, created by
...
man_pages = [
    (master_doc, "pytest-cookiecutterplugin_name", u"pytest-honors Documentation", [author], 1)
]
